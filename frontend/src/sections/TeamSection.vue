    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200">
        ...
        <p class="mt-3 text-gray-500">
          I enjoy cooking Filipino dishes and going on hikes during weekends. Just a simple person overall.
        </p>
      ...
      <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200">
        ...
        <p class="mt-3 text-gray-500">
          I love playing basketball and video games, but apart from that, pretty simple person.
        </p>
      ...
      <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200">
        ...
        <p class="mt-3 text-gray-500">
          I enjoy hiking mountains and playing guitar during weekends. Just a simple guy who loves exploring nature.
        </p>
      ...
      <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200">
        ...
        <p class="mt-3 text-gray-500">
          I love reading books and watching movies in my free time. Just a simple person who enjoys life.
        </p>
      ...
      <div class="flex flex-col rounded-xl p-4 md:p-6 bg-white border border-gray-200">
        ...
        <p class="mt-3 text-gray-500">
          I enjoy playing guitar and going on food adventures during weekends. Just a simple person who loves exploring new restaurants.
        </p>
