        ...
        <form @submit.prevent="handleSubmit">
          ...
          <div class="input-group">
            ...
            <div class="select-container">
              ...
              <button @click="addSelectedSubjects" class="add-button">
                Add
              </button>
            </div>
          </div>
          ...
          <div class="selected-subjects">
            ...
            >
              ...
              <button @click="removeSubject(subjectId)" class="remove-badge">
                ×
              </button>
            </span>
          </div>
...
const addSelectedSubjects = () => {
  // Add only unique subjects that aren't already in form.subjects
  const uniqueSubjects = [...new Set([...form.subjects, ...selectedSubjects.value])]
  form.subjects = uniqueSubjects
  selectedSubjects.value = [] // Clear the selection
}
