        ...
        <div class="flex flex-col bg-white h-full dark:bg-neutral-900">
          ...
          <div class="bg-gradient-to-r from-blue-600 to-blue-500 p-5 flex-none">
            <div class="flex flex-col md:flex-row md:justify-between items-center gap-4">
              ...
              <div class="flex flex-col items-center text-center md:items-start md:text-left md:flex-row md:w-3/5 gap-4">
                <img
                  alt="Tutor avatar"
                ...
                <div class="text-white">
                  ...
                  <div class="flex items-center justify-center md:justify-start gap-2 mt-1 text-blue-100">
          ...
          <div class="flex-1 overflow-y-auto p-6 space-y-8 dark:bg-neutral-900">
            ...
            <div class="prose prose-sm max-w-none dark:prose-invert">
              ...
              <div class="bg-gray-50 dark:bg-neutral-800 rounded-lg p-6 space-y-6">
                <!-- Subjects Section -->
          ...
          <div class="md:hidden sticky bottom-0 w-full bg-white dark:bg-neutral-900 px-4 py-3 border-t dark:border-neutral-700">
