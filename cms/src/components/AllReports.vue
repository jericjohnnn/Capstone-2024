      ...
      <div v-else class="space-y-4">
        ...
        >
          <div class="flex flex-row gap-x-4">
            <img
              :src="report.complainant_profile_image"
              alt="Profile"
            ...
            <div class="flex items-center">
              <button
                ...
                class="bg-blue-500 text-white px-2 py-1 rounded hover:bg-blue-600 mb-1"
              >
                View Report
              </button>
        ...
        <div class="flex flex-row">
          <div class="bg-blue-300 w-[400px] p-4 space-y-[100px]">
            ...
            <div class="mb-4">
              <div class="flex flex-row mt-4">
                <div class="mr-2">
                  <img
                    :src="selectedReport.offender_profile_image"
              ...
              <p>
                <strong>Offense Status:</strong>
                {{ selectedReport.offender_offense_status }}
              </p>
              <p>
                <strong>Contact Number:</strong>
                {{ selectedReport.offender_contact_number }}
              </p>
              <p>
          ...
          <div>
            <p class="text-lg font-semibold mb-2">
              <strong>Subject: </strong>{{ selectedReport.report_title }}
            </p>
...
const fetchReports = async () => {
  ...
  try {
    const response = await axiosInstance.get(
      'http://127.0.0.1:8000/api/admin/all-reports',
    )
