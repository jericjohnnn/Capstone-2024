  ...
  <div class="flex flex-col">
        ...
        <div class="overflow-x-auto">
          <div class="flex flex-col w-[68rem] space-y-2">
            ...
            <div class="overflow-y-auto max-h-[400px] w-[69rem]">
              <div v-for="student in paginatedStudents" :key="student.id" class="flex text-gray-600 justify-between py-2 w-full border-2 rounded-md bg-blue-200">
    ...
    <div class="flex justify-center space-x-2 mt-2">
      <button 
        ...
        class="bg-blue-500 text-white px-3 rounded-md hover:bg-blue-600 disabled:opacity-50">
